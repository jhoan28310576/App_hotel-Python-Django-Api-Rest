...
from gestion.models import Habitacion, Cliente, Reserva, Pago, Servicio, ServicioHabitacion
...
class MyAdminSite(admin.AdminSite):
    ...
    def get_app_list(self, request):
        ...
        order = {'User': 1, 'Group': 2, 'Habitacion': 3, 'Cliente': 4, 'Reserva': 5, 'Pago': 6, 'Servicio': 7, 'ServicioHabitacion': 8}
